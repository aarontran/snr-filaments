...
def main():
    ...
    parser = argparse.ArgumentParser(description=
             ('Plot and save data from DS9 projections. '
              'If only labels are provided, it will simply plot dat files'))
    ...
    parser.add_argument('-b', '--bands', help='Bands (.fits) to be processed',
                        nargs='*')
    ...
    bands, labels = args.bands, args.labels
