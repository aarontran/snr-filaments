...
def Width(params,data,eps_data):
    ...
    D = eta*Cd*E**mu/B0
    a = 2*D/vd/(numpy.sqrt(1+(4*D/vd**2/tsynch))-1)*4.6  # Factor of 4.6 tacked to equation (6) ??????
...
B0 = params['B0'].value
Egraph = numpy.sqrt(nugraph/cm/B0)  # Changed order with line above
# NEW LINE ADDED
rsarc = 900.
eta2 = params['eta2'].value
nu2 = 4.8359e17
...
# pylab.plot()  # COMMENTED TO SEE THE PLOT...
pylab.show()
