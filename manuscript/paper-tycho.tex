...
\note[Aaron]{this paragraph might belong in Section~\ref{sec:transport}?}
...
\begin{table*}[ht]
    ...
    %\input{tab-fwhms-ave-arith.tex}
    %\input{tab-fwhms-ave-geom.tex}
    \input{tab-fwhms.tex}
\end{table*}
...
\begin{table*}[ht]
    ...
    \label{tab:fits}}
    \input{tab-fits-flmt1.tex}  % TODO CHANGE/UPDATE THIS
\end{table*}
