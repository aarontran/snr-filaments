...
% TODO define loss-limited properly...
% ~210 words -- a little too long
\begin{abstract}
...
coefficients (typically $\abt 1$--$10$).
Corresponding thin rim radio rims require magnetic damping, however.  We
jointly model radio and X-ray profiles and estimate magnetic damping length of
order $1$--$5$\% of remnant radius, with magnetic field strengths $\abt
50$--$400 \muG$ assuming Bohm diffusion.  Diffusion coefficients, magnetic
field strengths, and magnetic damping lengthscales are somewhat degenerate in
setting observed rim widths and drop-offs.
...
\begin{figure}
    \centering
    \iftoggle{manuscript}{
        \includegraphics[width=0.2\textwidth]{figures/snr.pdf}
    }{
...
% -------------------------------
% srcutlog and spectral variation
% -------------------------------
...
fit \ion{S}{15} line; excising all $2$--$2.6 \unit{keV}$ photons) yielded a
...
\note[Aaron]{Was data from all configurations merged?  Done by \citet{reynoso1997}.}
...
\begin{figure}
    \centering
    \plotone{figures/radio-snr.png}  % TODO a temporary image
...
% Procedure: compare to previous work
...
% TODO what happens if \Bmin = 2 \muG?!
...
% TODO We have NOT considered the relative intensities of X-ray / radio rims!
