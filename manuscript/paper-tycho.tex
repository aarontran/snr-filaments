...
and particle diffusion coefficients $\abt1$--$100\times$ Bohm values, whereas
magnetic damping permits magnetic fields of $\abt 10$--$300 \muG$ and
...
\begin{figure}
    \centering
    \iftoggle{manuscript}{ % TODO a temporary image
