...
\begin{table}
    ...
    \tablecomments{Best damped fits select best $a_b$ value below $0.01$ from
    the range shown in Table~\ref{tab:fits-damp}, enforcing moderate damping.
    Fits for Regions 1--3, 5, 11, 12, 18, and 19 have 3 degrees of freedom; all
    others have 4.  The manual selection of a best $a_b$ value may be construed
    as removing one additional dof.}
\end{table}

% TODO EXPLAIN/DISCUSS
