...
def get_fwhm_all(x, y, y_err, f, pars, want_err=True, y_cap=None,
                 dx=5, blist=None, **kwargs):
    """After running a fit routine, compute useful numbers associated with FWHM

    dx=5 arcsec empirically works okay for Tycho
    Twiddle as needed...
    **kwargs passed to stretch computation functions
    Output:
...
# FWHM error calculation functions
